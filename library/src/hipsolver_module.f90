...
module hipsolver
    ...
    ! ******************** SYEVDX/HEEVDX ********************
    interface
        function hipsolverSsyevdx_bufferSize(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu, nev, W, lwork) &
                result(c_int) &
    ...
    interface
        function hipsolverDsyevdx_bufferSize(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu, nev, W, lwork) &
                result(c_int) &
    ...
    interface
        function hipsolverCheevdx_bufferSize(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu, nev, W, lwork) &
                result(c_int) &
    ...
    interface
        function hipsolverZheevdx_bufferSize(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu, nev, W, lwork) &
                result(c_int) &
    ...
    interface
        function hipsolverSsyevdx(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu, nev, W, work, lwork, info) &
                result(c_int) &
    ...
    interface
        function hipsolverDsyevdx(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu, nev, W, work, lwork, info) &
                result(c_int) &
    ...
    interface
        function hipsolverCheevdx(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu, nev, W, work, lwork, info) &
                result(c_int) &
    ...
    interface
        function hipsolverZheevdx(handle, jobz, range, uplo, n, A, lda, vl, vu, il, iu, nev, W, work, lwork, info) &
                result(c_int) &
