...
For more information on building and installing hipSOLVER, see the [hipSOLVER install guide](https://rocm.docs.amd.com/projects/hipSOLVER/en/latest/installation/install.htmll).

### Building hipSOLVER for the NVIDIA CUDA platform

For the purposes of porting an application from NVIDIA to CUDA, it's possible to build hipSOLVER to run on NVIDIA hardware.
