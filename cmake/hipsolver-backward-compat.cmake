...
set(PROJECT_FILE_REORG_INC_DIR    ${PROJECT_SOURCE_DIR}/library/include/hipsolver)
set(PROJECT_WRAPPER_TEMPLATE_FILE ${PROJECT_SOURCE_DIR}/header.hpp.in)
set(PROJECT_WRAPPER_INC_DIR       ${PROJECT_BINARY_DIR}/hipsolver/include)
set(PROJECT_SLINK_WRAPPER_INC_DIR ${PROJECT_BINARY_DIR}/include)

#Relative Path for wrapper and symlink wrapper (hipsolver/include and include/ resp.) files generated 
set(PROJECT_WRAPPER_INC_RELATIVE_PATH     "${include_statements}#include \"../../include/hipsolver")
set(PROJECT_SLINK_INC_RELATIVE_PATH       "${include_statements}#include \"./hipsolver")


# Function for Generating Wrapper Headers for Backward Compatibilty
# Generates wrapper for all *.h files in include/hipsolver folder.
# No Arguments to function.
# Wrapper are generated under hipsolver/include and symlink under include/.
function (package_gen_bkwdcomp_hdrs)
	# Get list of *.h files in folder include/hipsolver 
...
# Wrapper generated for the input file under hipsolver/include and symlink under include/.
